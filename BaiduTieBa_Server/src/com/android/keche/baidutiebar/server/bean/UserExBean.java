...
public class UserExBean  {
   ...
   public UserExBean(String name, String password, String iconString, int fansNum, int focusNum) {
       this.name = name;
       this.password = password;
       this.iconUrl = iconString;
...
/**
   ...
   public void setIconUrl(String iconString) {
       this.iconUrl = iconString;
   }
