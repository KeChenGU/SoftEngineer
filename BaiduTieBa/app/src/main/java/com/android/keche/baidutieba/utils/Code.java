...
public class Code {
    ...
    private static Code bmpCode;            /**< 随机验证码 **/
    ...
    //variables
    private String code;                        /**< 储存随机验证码字符串 **/
    private int padding_left, padding_top;    /**< padding值 **/
...
//        Canvas.ALL_SAVE_FLAG 原本在下方的括号中
        c.save();//保存
        c.restore();//
        return bp;
    }
