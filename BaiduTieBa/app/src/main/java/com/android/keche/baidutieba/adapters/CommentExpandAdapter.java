package com.android.keche.baidutieba.adapters;
...
public class CommentExpandAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpand, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null){
            ...
            userIcon = convertView.findViewById(R.id.comment_item_logo);
            String iconUrl = "userIcon/face_happy.png";
            if (MainActivity.userEx != null && !MainActivity.userEx.getIconUrl().equals("")) {
                iconUrl = MainActivity.userEx.getIconUrl();
            }
            Glide.with(convertView.getContext()).load(MainActivity.DEFAULT_SERVER_URL + iconUrl).into(userIcon);
